...
public class StudentCtl extends BaseCtl {
    ...
    /* (non-Javadoc)
     * @see in.co.rays.project_4.controller.BaseCtl#preload(javax.servlet.http.HttpServletRequest)
     */
    @Override
    ...
    protected void doPost(HttpServletRequest request,
        ...
        if (OP_SAVE.equalsIgnoreCase(op)|| OP_UPDATE.equalsIgnoreCase(op)) {
            ...
            System.out.println("StudentCtl doPost OP_SAVE line 187...");
            try {
                System.out.println("StudentCtl doPost OP_SAVE try block line 189..." +id);
                if (id > 0) {
                    model.update(bean);
                    System.out.println("StudentCtl model updated....");
                    ServletUtility.setBean(bean, request);
