...
public class StudentModel {
	...
	public long add(StudentBean bean) throws ApplicationException, DuplicateRecordException {
	    ...
	    System.out.println("add started line 63");
	    Connection conn = null;
	    ...
	    try {
	        ...
	        System.out.println("Student model before date line no 88");
	        pstmt.setDate(6, new java.sql.Date(bean.getDob().getTime()));
	        System.out.println("Student model after date line no 90");
	...
	public void update(StudentBean bean) throws ApplicationException, DuplicateRecordException {
		...
		System.out.println("Student update line 254");
		Connection conn = null;
		...
		try {
			System.out.println("student update try line 270");

			conn = JDBCDataSource.getConnection();

			conn.setAutoCommit(false); // Begin transaction
			PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE ST_STUDENT SET COLLEGE_ID=?,COLLEGE_NAME=?,FIRST_NAME=?,LAST_NAME=?,DOB=?,MOBILE_NO=?,EMAIL=?,CREATED_BY=?,MODIFIED_BY=?,CREATED_DATETIME=?,MODIFIED_DATETIME=? WHERE ID=?");
			pstmt.setLong(1, bean.getCollegeId());
			pstmt.setString(2, bean.getCollegeName());
			pstmt.setString(3, bean.getFirstName());
			pstmt.setString(4, bean.getLastName());
			System.out.println("student model update  before date");
			pstmt.setDate(5, new java.sql.Date(bean.getDob().getTime()));
			System.out.println("student model update  after date");
			...
			System.out.println("student model update end 293..." +bean.getId());
			pstmt.executeUpdate();
			System.out.println("student model update end 295..." +bean.getId());
			conn.commit(); // End transaction
			System.out.println("student model update end 297..." +bean.getId());
			pstmt.close();
			System.out.println("student model update end 299...");
		} catch (Exception e) {
			log.error("Database Exception..", e);
