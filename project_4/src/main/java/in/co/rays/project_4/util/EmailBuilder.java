...
public class EmailBuilder {
	...
	getUserRegistrationMessage(HashMap<String,String>map) {
		System.out.println("EmailBuilder.getUserRegistrationMessage(map) line 27");
	    ...
	    public static String getForgetPasswordMessage(HashMap<String, String> map) {
	    	System.out.println("EmailBuilder.getForgetPasswordMessage()map line 55");
	    	StringBuilder msg = new StringBuilder();
	    ...
	    public static String getChangePasswordMessage(HashMap<String, String> map) {
	    	System.out.println("EmailBuilder.getChangePasswordMessage(map) line 80");
	        StringBuilder msg = new StringBuilder();
