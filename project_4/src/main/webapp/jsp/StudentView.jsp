...
<body>
	  ...
	  <tr><th style="padding: 3px"></th></tr>    	
		...
		<td style="position: fixed"><font  color="red"><%=ServletUtility.getErrorMessage("lastname", request)%></font>
		 ...
		 <tr>
          ...
          <td><input type="text" name="dob" id="udate4"  placeholder=" Date of Birth" value="<%=DataUtility.getDateString(bean.getDob())%>"></td> 
   ...
   <tr><th style="padding: 3px"></th></tr>    
		...
		<td><input type="text" name="mobile" maxlength="10" placeholder="Enter Mobile No"  value="<%=DataUtility.getStringData(bean.getMobileNo())%>"></td>
		...
		<td><input type="text" name="email" placeholder="Enter Email_Id"  value="<%=DataUtility.getStringData(bean.getEmail())%>"></td>
